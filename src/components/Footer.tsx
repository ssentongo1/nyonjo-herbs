...
export default function Footer() {
  ...
  const renderLogo = () => {
    if (loading) {
      return (
        <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl flex items-center justify-center animate-pulse">
    ...
    return (
      <div className="w-full h-full bg-gradient-to-br from-rose-500 to-pink-600 rounded-xl flex items-center justify-center">
        <span className="text-xl text-white font-bold">NH</span>
      </div>
    )
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 md:space-x-4 mb-4">
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-bold mb-1">Nyonjo Herbs</h2>
          ...
          <div>
            <h3 className="text-base md:text-lg font-bold mb-3 md:mb-4">Explore</h3>
          ...
          <div>
            ...
            <div className="mt-6 pt-4 border-t border-rose-800">
