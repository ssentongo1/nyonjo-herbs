      ...
      <section className="py-8 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-lg md:shadow-xl border border-rose-100 p-6 md:p-10 mb-8 md:mb-12">
              <div className="flex items-center mb-6 md:mb-8">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-rose-400 to-pink-500 rounded-full flex items-center justify-center mr-4 md:mr-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm md:text-base">Effective: November 2024</p>
                </div>
              </div>

              <div className="space-y-6 md:space-y-8">
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">1. Acceptance of Terms</h3>
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">2. Platform Description</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">3. Medical Disclaimer</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">4. User Responsibilities</h3>
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">5. Community Guidelines</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">6. Purchases & Payments</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">7. Intellectual Property</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">8. Limitation of Liability</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">9. Changes to Terms</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4">10. Contact</h3>
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
